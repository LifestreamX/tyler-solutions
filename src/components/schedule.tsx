...
const scheduleHighlights = [
  ...
  {
    icon: Clock3,
    title: 'Straight to what matters',
    description: 'We focus on the problem, the goal, and the best next step.',
  },
  {
    icon: MessageSquareText,
    title: 'Clear next step after the call',
    description:
  ...
  return (
    ...
    >
      <div className='max-w-7xl mx-auto px-6 lg:px-8'>
        <div className='grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-12'>
          <FadeUp>
            <div>
              ...
              <p className='text-muted-foreground leading-relaxed mb-8'>
                Pick a time here if talking it through live is the fastest way
                to move. We can cover the project, what is blocked, and the best
                next step.
              </p>
              ...
              <div className='mt-6 rounded border border-border bg-surface p-5 shadow-sm dark:shadow-none'>
                ...
                <p className='text-sm leading-relaxed text-muted-foreground'>
                  If you would rather send the details first, the contact form
                  is right below.
                </p>
                <a
                  href='#contact'
          ...
          <FadeUp delay={0.1}>
            <div className='card-workstation p-3 sm:p-4'>
              <div className='rounded border border-border bg-background p-4 sm:p-5'>
                <div className='mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
                  ...
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    onClick={() => trackBookCallClick('schedule_full_calendar')}
                    className='inline-flex min-h-11 items-center justify-center gap-2 rounded border border-border bg-surface px-4 py-2 text-sm font-semibold text-foreground shadow-sm transition-all duration-300 hover:-translate-y-px hover:border-accent/40 hover:text-accent hover:shadow-md dark:shadow-none dark:hover:shadow-none'
                  >
                    Open Full Calendar
                    <ArrowUpRight className='h-4 w-4' aria-hidden='true' />
                  </a>
